...
* Студент: [Светлана Старцева](https://up.htmlacademy.ru/univer-html1/2/user/2431085).
* Наставник: `Самохвалов Алексей Владимирович` (https://github.com/avsamohvalov).
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-univer-htmlcss-1/2431085-sedona-2) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
